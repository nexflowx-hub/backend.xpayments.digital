...
// ==========================================
// SUPERFÍCIE PÚBLICA (Sem JWT)
// ==========================================
app.get('/api/health', (req, res) => res.json({ status: 'V3_ONLINE' }));
app.use('/api/v1/auth', authRoutes);

// Rota de Iniciação de Pagamentos (Aberta para o Frontend de Checkout)
app.use('/api/v1/checkout', checkoutRoutes);

// ROTA S2S: Orquestração Direta para integrações "drop-in"
app.use('/api/v1/payments', paymentRoutes);

// ==========================================
// SUPERFÍCIE PRIVADA (Exige JWT)
// ==========================================
